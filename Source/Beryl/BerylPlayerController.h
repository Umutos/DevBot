...
#include "BerylPlayerController.generated.h"
 ...
 */
UCLASS(abstract)
class BERYL_API ABerylPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ABerylPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UBerylUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UBerylUI> VehicleUI;
